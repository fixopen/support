...
<div class="container">
    <div class="row" style="background-color: #e9e9e9; min-height: 820px;">
        ...
        <div class="col-lg-12">
            ...
            <div class="inputArea">
                <strong>书名：</strong> <input type="text"  name="name" id="name" />
                <div id="name_error" class="error" zd="name" yz="bt">请填写书名</div>
            </div>
            <div class="inputArea">
                <strong>准用号：</strong> <input type="text"  name="quasiUseNo" id="quasiUseNo" />
            ...
            <div class="inputArea">
                ...
                <input type="text"  name="cover" id="cover" readonly />
            ...
            <div class="inputArea">
                <strong>学科：</strong> <input type="text"  name="subject" id="subject" />
                <div id="subject_error" class="error" zd="subject" yz="bt">请填写学科</div>
            </div>
            <div class="inputArea">
                <strong>作者：</strong> <input type="text"  name="author" id="author" />
                <div id="author_error" class="error" zd="author" yz="bt">请填写作者</div>
            </div>
            <div class="inputArea">
                <strong>出版社：</strong> <input type="text"  name="publisher" id="publisher" />
                <div id="publisher_error" class="error" zd="publisher" yz="bt">请填写出版社</div>
            </div>
            <div class="inputArea">
                <strong>学段：</strong> <input type="text"  name="stage" id="stage" />
